 ...
 */
;(function(id){ var element = document.getElementById(id); if (element) element.innerHTML = " - " + new Date().getFullYear(); })("current-year");

/*!
 * scrollreveal.js
 * Easy scroll animations for web and mobile browsers. https://scrollrevealjs.org/
